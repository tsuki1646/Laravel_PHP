...
<head>
    ...
    <link href="{{ asset('backend/assets/plugins/flag-icons/css/flag-icon.min.css') }}assets/plugins/flag-icons/css/flag-icon.min.css" rel="stylesheet"/>
    ...
    <div class="wrapper">
        ...
        <aside class="left-sidebar bg-sidebar">
            ...
            <!-- Aplication Brand -->
                ...
                <!-- sidebar menu -->
                <ul ul class="nav sidebar-inner" id="sidebar-menu">
